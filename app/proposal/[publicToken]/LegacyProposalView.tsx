...
/**
 * The original market-classification proposal presentation, unchanged.
 * Kept because proposals created before the quote builder still render through
 * it; new quote proposals use ClientProposalView instead.
 */
...
export default LegacyProposalView;
