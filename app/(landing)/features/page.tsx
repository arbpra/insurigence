    ...
    <section className="cs_gray_bg_2 features-panel">
      ...
      <div className="container">
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-medium tracking-tight mb-3"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-2"
          >
        ...
        {/* Cards Section */}
        <motion.div
          className="row cs_row_gap_30 cs_gap_y_30 features-panel"
          initial="hidden"
          whileInView="visible"
