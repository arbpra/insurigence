...
export default function MainLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-6" style={{background:'rgb(5, 49, 76)'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <p className="text-sm text-white">&copy; 2026 Insurigence. All rights reserved.</p>
            <div className="flex items-center gap-4">
              <a href="#" className="text-sm text-white hover:text-gray-700">Privacy</a>
              <a href="#" className="text-sm text-white hover:text-gray-700">Terms</a>
            </div>
          </div>
        </div>
      </footer>
